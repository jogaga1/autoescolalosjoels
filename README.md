...
Un altre apartat important seria el calendari, on es mostrarien totes les hores de classes teòriques, pràctiques i exàmens, així com altres activitats o recordatoris.
Per millorar l’experiència de l’usuari, es podria afegir un sistema de notificacions (per exemple, quan s’aproxima un examen o es publica un nou vídeo), un historial de resultats per seguir el progrés personal i un perfil d’usuari on cada alumne pugui veure i actualitzar les seves dades bàsiques.
En conjunt, aquesta pàgina web facilitaria l’aprenentatge, la comunicació i l’organització tant per als alumnes com per al professorat, convertint-se en una eina útil i moderna per a l’educació.
